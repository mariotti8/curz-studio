...
export default function CheckoutPage() {
  ...
  if (!PURCHASES_ENABLED) return <main className="checkout-page checkout-done"><div><p className="brand">CURZ STUDIO</p><span>Triade</span><h1>{t("purchasesSoon")}</h1><p>{t("purchasePaused")}</p><Link href="/#prodotto">{t("discoverTriade")}</Link></div></main>;

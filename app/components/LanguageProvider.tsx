...
const copy: Record<Language, Record<string, string>> = {
  it: {
    ...
    purchasesSoon: "Acquisti presto disponibili", purchasePaused: "Le vendite online non sono ancora attive. Triade tornerà disponibile a breve.",
  ...
  en: {
    ...
    purchasesSoon: "Purchases coming soon", purchasePaused: "Online sales are not active yet. Triade will be available again soon.",
